...
use Skywalker\Laraguard\Contracts\TwoFactorTotp;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\MorphTo;
use Skywalker\ConstantTime\Base32;
use Skywalker\Laraguard\Models\Concerns\HandlesCodes;
use Skywalker\Laraguard\Models\Concerns\HandlesRecoveryCodes;
use Skywalker\Laraguard\Models\Concerns\HandlesSafeDevices;
use Skywalker\Laraguard\Models\Concerns\SerializesSharedSecret;
 ...
 *
 * @property-read null|\Skywalker\Laraguard\Contracts\TwoFactorAuthenticatable $authenticatable
 *
 * @property string $shared_secret
 * @property string $panic_code
...
class TwoFactorAuthentication extends Model implements TwoFactorTotp
{
    ...
    {
        return \Database\Factories\Skywalker\Laraguard\Models\TwoFactorAuthenticationFactory::new();
    }
