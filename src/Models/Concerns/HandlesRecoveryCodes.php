...
namespace Skywalker\Laraguard\Models\Concerns;
...
trait HandlesRecoveryCodes
{
    ...
    {
        return (bool) ($this->recovery_codes && $this->recovery_codes->contains('used_at', '==', null));
    }
    ...
    {
        return $this->recovery_codes ? $this->recovery_codes->search([
            'code' => $code,
            'used_at' => null,
        ], true) : null;
    }
