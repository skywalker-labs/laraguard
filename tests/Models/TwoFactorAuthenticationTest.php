...
class TwoFactorAuthenticationTest extends TestCase
{
    ...
    public function test_serializes_to_qr_and_renders_to_qr(): void
    {
        ...
        $expected = str_replace("\r", '', file_get_contents(__DIR__ . '/../Stubs/QrStub.svg'));
        $this->assertEquals($expected, str_replace("\r", '', $tfa->toQr()));
        $this->assertEquals($expected, str_replace("\r", '', $tfa->render()));
    }
    ...
    public function test_serializes_to_qr_and_renders_to_qr_with_custom_values(): void
    {
        ...
        $expected = str_replace("\r", '', file_get_contents(__DIR__ . '/../Stubs/CustomQrStub.svg'));
        $this->assertEquals($expected, str_replace("\r", '', $tfa->toQr()));
        $this->assertEquals($expected, str_replace("\r", '', $tfa->render()));
    }
