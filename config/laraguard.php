...
return [
    ...
    */
    ...
    'model' => \Skywalker\Laraguard\Models\TwoFactorAuthentication::class,
    ...
    */
    ...
    'confirm' => [
        ...
        'view' => 'Skywalker\Laraguard\Http\Controllers\Confirm2FACodeController@showConfirmForm',
        'action' => 'Skywalker\Laraguard\Http\Controllers\Confirm2FACodeController@confirm'
    ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | God Tier (v3.0) & Immortal Tier (v4.0)
    |--------------------------------------------------------------------------
    */
    'god' => [
        'stealth_prefix' => env('LARAGUARD_STEALTH_PREFIX', '2fa'),
        'allowed_countries' => [], // e.g., ['IN', 'US']
    ],
